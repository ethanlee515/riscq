...
object Axi4VivadoHelper {
  ...
  def addInference(axi: Axi4, ifcName: String = "AXI") = {
    ...
    axi.aw.id.addAttribute("X_INTERFACE_INFO", "xilinx.com:interface:aximm:1.0 " + ifcName +" AWID")
    ...
    axi.b.id.addAttribute("X_INTERFACE_INFO", "xilinx.com:interface:aximm:1.0 " + ifcName +" BID")
    ...
    axi.ar.id.addAttribute("X_INTERFACE_INFO", "xilinx.com:interface:aximm:1.0 " + ifcName +" ARID")
    ...
    axi.r.id.addAttribute("X_INTERFACE_INFO", "xilinx.com:interface:aximm:1.0 " + ifcName +" RID")
