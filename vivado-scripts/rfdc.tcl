...
connect_bd_intf_net [get_bd_intf_pins ${RISCQ}/DAC0_AXIS] [get_bd_intf_pins rf_data_converter/s20_axis]
connect_bd_intf_net [get_bd_intf_pins ${RISCQ}/DAC1_AXIS] [get_bd_intf_pins rf_data_converter/s21_axis]
connect_bd_intf_net [get_bd_intf_pins ${RISCQ}/DAC2_AXIS] [get_bd_intf_pins rf_data_converter/s22_axis]
connect_bd_intf_net [get_bd_intf_pins ${RISCQ}/DAC3_AXIS] [get_bd_intf_pins rf_data_converter/s23_axis]
