...
connect_bd_intf_net [get_bd_intf_pins ${RISCQ}/DAC8_AXIS] [get_bd_intf_pins rf_data_converter/s20_axis]
connect_bd_intf_net [get_bd_intf_pins ${RISCQ}/DAC9_AXIS] [get_bd_intf_pins rf_data_converter/s21_axis]
connect_bd_intf_net [get_bd_intf_pins ${RISCQ}/DAC10_AXIS] [get_bd_intf_pins rf_data_converter/s22_axis]
connect_bd_intf_net [get_bd_intf_pins ${RISCQ}/DAC11_AXIS] [get_bd_intf_pins rf_data_converter/s23_axis]
connect_bd_intf_net [get_bd_intf_pins ${RISCQ}/DAC12_AXIS] [get_bd_intf_pins rf_data_converter/s30_axis]
connect_bd_intf_net [get_bd_intf_pins ${RISCQ}/DAC13_AXIS] [get_bd_intf_pins rf_data_converter/s31_axis]
connect_bd_intf_net [get_bd_intf_pins ${RISCQ}/DAC14_AXIS] [get_bd_intf_pins rf_data_converter/s32_axis]
connect_bd_intf_net [get_bd_intf_pins ${RISCQ}/DAC15_AXIS] [get_bd_intf_pins rf_data_converter/s33_axis]
...
connect_bd_intf_net [get_bd_intf_pins ${RISCQ}/ADC4_AXIS] [get_bd_intf_pins rf_data_converter/m30_axis]
connect_bd_intf_net [get_bd_intf_pins ${RISCQ}/ADC5_AXIS] [get_bd_intf_pins rf_data_converter/m31_axis]
connect_bd_intf_net [get_bd_intf_pins ${RISCQ}/ADC6_AXIS] [get_bd_intf_pins rf_data_converter/m32_axis]
connect_bd_intf_net [get_bd_intf_pins ${RISCQ}/ADC7_AXIS] [get_bd_intf_pins rf_data_converter/m33_axis]
