...
connect_bd_intf_net [get_bd_intf_pins ${RISCQ}/ADC4_AXIS] [get_bd_intf_pins rf_data_converter/m10_axis]
connect_bd_intf_net [get_bd_intf_pins ${RISCQ}/ADC5_AXIS] [get_bd_intf_pins rf_data_converter/m11_axis]
connect_bd_intf_net [get_bd_intf_pins ${RISCQ}/ADC6_AXIS] [get_bd_intf_pins rf_data_converter/m12_axis]
connect_bd_intf_net [get_bd_intf_pins ${RISCQ}/ADC7_AXIS] [get_bd_intf_pins rf_data_converter/m13_axis]
