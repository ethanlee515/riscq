proc create_riscq_bd {} {
    ...
    # dsp clock
    create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:diff_clock_rtl:1.0 clk500m
    connect_bd_intf_net [get_bd_intf_ports clk500m] [get_bd_intf_pins ${CLKIFC}/clk500m_diff]

    # clk100m for bus
    create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:diff_clock_rtl:1.0 clk100m
    connect_bd_intf_net [get_bd_intf_ports clk100m] [get_bd_intf_pins ${CLKIFC}/clk100m_diff]
    ...
    connect_bd_net [get_bd_pins ${CLKIFC}/clk100m] [get_bd_pins ${AXI_CONNECT}/aclk1] [get_bd_pins ${AXI_GPIO}/s_axi_aclk] [get_bd_pins ${PS_RST}/slowest_sync_clk] [get_bd_pins ${RISCQ}/clk100m]
    connect_bd_net -net rf_data_converter_clk [get_bd_pins ${CLKIFC}/clk500m] [get_bd_pins ${RISCQ}/clk500m] [get_bd_pins ${DSP_RST}/slowest_sync_clk]
    # connect_bd_net -net ${RISCQ_NAME}_clk500m [get_bd_pins ibufds_clk500m/IBUF_OUT] [get_bd_pins ${RISCQ}/clk] [get_bd_pins ${AXI_CONNECT}/aclk1] [get_bd_pins ${DSP_RST}/slowest_sync_clk]
    # connect_bd_net -net ${RISCQ_NAME}_clk500m [get_bd_pins ibufds_clk500m/IBUF_OUT] [get_bd_pins ${RISCQ}/clk] [get_bd_pins ${AXI_CONNECT}/aclk1] [get_bd_pins ${DSP_RST}/slowest_sync_clk] [get_bd_pins rf_data_converter/m0_axis_aclk] [get_bd_pins rf_data_converter/s0_axis_aclk] [get_bd_pins rf_data_converter/m1_axis_aclk] [get_bd_pins rf_data_converter/s1_axis_aclk] [get_bd_pins rf_data_converter/m2_axis_aclk] [get_bd_pins rf_data_converter/s2_axis_aclk] [get_bd_pins rf_data_converter/m3_axis_aclk] [get_bd_pins rf_data_converter/s3_axis_aclk] [get_bd_pins rf_data_converter/s_axi_aclk]

    global DSP_FREQ
    # set_property -dict [list CONFIG.FREQ_HZ ${DSP_FREQ}] [get_bd_pins ${AXI_CONNECT}/aclk1]
    set_property -dict [list CONFIG.FREQ_HZ ${DSP_FREQ}] [get_bd_intf_ports clk500m]
    set_property -dict [list CONFIG.FREQ_HZ ${DSP_FREQ}] [get_bd_pins ${RISCQ}/clk500m]
    set_property -dict [list CONFIG.FREQ_HZ ${DSP_FREQ}] [get_bd_pins ${CLKIFC}/clk500m]
    set_property -dict [list CONFIG.FREQ_HZ {100000000}] [get_bd_intf_ports clk100m]
    set_property -dict [list CONFIG.FREQ_HZ {100000000}] [get_bd_pins ${RISCQ}/clk100m]
    ...
    connect_bd_net -net ${DSP_RST_NAME}_peripheral_reset [get_bd_pins ${DSP_RST}/peripheral_reset] [get_bd_pins ${RISCQ}/rst500m]
    connect_bd_net -net ${PS_RST_NAME}_peripheral_reset [get_bd_pins ${PS_RST}/peripheral_reset] [get_bd_pins ${RISCQ}/rst100m]
